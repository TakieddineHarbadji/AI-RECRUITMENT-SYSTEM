         ...
         Edit
          ...
          <div className="flex justify-center mt-8">
            <nav className="flex items-center space-x-1">
              ...
              <button className="w-8 h-8 flex items-center justify-center rounded-full text-[#5e6670] hover:bg-[#f1f2f4]">
                02
              </button>
              <button className="w-8 h-8 flex items-center justify-center rounded-full text-[#5e6670] hover:bg-[#f1f2f4]">
                03
...
function JobCard({ logo, logoBackground, title, type, location, salary, days, highlighted, bookmarked = false }) {
  ...
  return (
    ...
    >
      ...
      >
        <img src={logo || "/placeholder.svg"} width={24} height={24} alt={title} />
      </div>
      <div className="flex-1">
